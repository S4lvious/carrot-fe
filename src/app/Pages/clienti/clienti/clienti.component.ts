...
export class ClientiComponent  {
  ...
  public config: CrudTableConfig = {
    ...
    actions: {
      add: (item) => this._loaderService.load(ClientiAddDialogComponent, item).then(() => this._clientiService.getClients().subscribe((clienti) => this.clients = clienti)),  // 🔥 Corretto!
      edit: (item) => this._loaderService.load(ClientiAddDialogComponent, item).then(() => this._clientiService.getClients().subscribe((clienti) => this.clients = clienti)),  // 🔥 Corretto!
      delete: (item) =>
